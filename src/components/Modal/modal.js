...
<svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  1.17.08 1.78 1.2 1.78 1.2 1.04 1.78 2.73 1.27 3.4.97.11-.76.41-1.27.74-1.56
  -2.55-.29-5.23-1.28-5.23-5.7 0-1.26.45-2.29 1.19-3.1-.12-.29-.52-1.46.11-3.05
  0 0 .97-.31 3.18 1.18a11.06 11.06 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18
  .63 1.59.23 2.76.11 3.05.74.81 1.19 1.84 1.19 3.1
  0 4.43-2.69 5.4-5.25 5.69.42.36.79 1.08.79 2.18
  0 1.57-.01 2.83-.01 3.22 0 .31.21.68.8.56
...
<svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.22 8h4.56v14H.22V8zM8.98 8h4.37v1.91h.06
  c.61-1.16 2.1-2.38 4.32-2.38 4.62 0 5.47 3.04 5.47 6.99V22h-4.56v-6.57
  c0-1.57-.03-3.59-2.19-3.59-2.19 0-2.52 1.71-2.52 3.48V22H8.98V8z"/>
</svg>
`;
  ...
  return `
    <li class="team-card">
      ...
      <div class="team-card__links">
        ${
          gh
            ? `<a class="team-card__icon" href="${gh}" target="_blank" rel="noreferrer" aria-label="GitHub">
                 ${githubIcon}
               </a>`
            : ""
        }
        ${
          li
            ? `<a class="team-card__icon" href="${li}" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                 ${linkedinIcon}
               </a>`
            : ""
        }
...
export const openTeamModal = () => {
  const membersHtml = (Array.isArray(team) ? team : [])
    .map(createTeamMemberCard)
    .join("");

  const html = render(teamModalTpl, { members: membersHtml });
  openModal(html);
};
